...
public class Oauth2 {
    ...
    public static String getCode(){
        ...
        String s1 = HttpclientUtil.doGet("https://api.weibo.com/oauth2/authorize?client_id=3059068254&response_type=code&redirect_uri=http://passport.gmall.com:8086/vlogin");
